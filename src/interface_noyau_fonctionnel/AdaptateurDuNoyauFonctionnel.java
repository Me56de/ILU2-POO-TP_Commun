...
public class AdaptateurDuNoyauFonctionnel {
	...
	public AdaptateurDuNoyauFonctionnel(ControlReserverTable controlReserverTable,
	...
	public String[] trouverTableDisponible(int jour, int mois, int nombrePersonnes, String time) {
		...
		propositions = controlReserverTable.trouverPossibilite(jour, mois, nombrePersonnes, numService);
		int nbProposition = 0;
	...
	public String reserverTable(int numClient, int numTable/*, int[] proposition*/) {
		controlReserverTable.reserver(numClient, numTable, propositions[0]);
